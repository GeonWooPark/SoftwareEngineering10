...
<html lang="ko">
	...
	<body>
		...
		<?php
			...
			$select_query2 = "SELECT * FROM teacher_intro where id='$tea'"; 
			...
			<section id="main" class="wrapper">
				<div class="container" style="width:800px;">
					<header class="major special">
						<h2>LECTURE</h2>
						<p><?php echo $row2["name"]; ?>&nbsp;선생님의 강좌 페이지입니다.</p>
					</header>
					<hr>
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align: center;">
												...
												<a href="../teacher/lecture.php?<?php printf($row1["category"]);?>?<?php printf($row1["id"]);?>?<?php printf($row1["date"]);?>" style="text-decoration:none;">
													<strong><?php printf($row1["title"]);?></strong>
												</a>
												...
												<a href="../payment/pay.php" style="text-decoration:none;">
													<strong><?php printf($row1["title"]);?></strong> 
												</a>
