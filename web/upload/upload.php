			...
			<section id="main" class="wrapper">
				<div class="container">
					<header class="major special">
						<h2>UPLOAD</h2>
						<p>원하는 스크립트를 클릭하여 녹음파일을 업로드 하세요!</p>
					</header>
					<hr>
							...
							<div class="table-wrapper">
								<table>
									...
									<tbody>
										...
										<?php 
											$select_query1 = "SELECT title, script, index_id, Chart_category, day FROM Chart_script"; 
										...
										<tr>
											<td>
												<?php echo $audio_array[$audio_count]+1;?>
											</td>
											<td>
												<?php printf($row1["Chart_category"]);?>
											</td>
											<td style="text-align: left;">
												<a href="record.php?<?php printf($row1["Chart_category"]);?>?<?php printf($row1["index_id"]);?>" style="text-decoration:none;">
