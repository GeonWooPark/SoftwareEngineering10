	...
	<div class="limiter" style="height: 750px;">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				...
				<form class="login100-form validate-form flex-sb flex-w" action="mailer.php" method="POST">
					<span class="login100-form-title p-b-51">
						회원가입 1단계
					</span>
					<h4>
						이메일을 입력하시면 해당 이메일로 인증번호가 전송됩니다.
					</h4>
					...
					<div class="container-login100-form-btn m-t-17">
						<input type="submit" class="login100-form-btn" value="다음 단계" style="color:#3A1D1D !important; background-color: #ffdf00">
