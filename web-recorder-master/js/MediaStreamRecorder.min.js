...
function MediaStreamRecorder(mediaStream) {
    ...
    this.start = function(timeSlice) {
        ...
        mediaRecorder.onstart = this.onstart;
...
// 수정자 : 이창환
// onstart 이벤트가 fire 되지 않아 호출하는 구현을 추가하였습니다.
...
// 수정자 : 이창환
// 인코딩 없이 decoded sequence를 직접 전달할 수 있도록 audio/raw 형식을 지정하였습니다.
// 이때, ondataavailable에서 {data:Float32Array, sampleRate:sampleRate}을 전달합니다.
function StereoAudioRecorderHelper(mediaStream, root) {
    ...
    var isRaw = mimeType.indexOf('audio/raw') > -1;
    ...
    this.requestData = function() {
        ...
        if (isRaw) {
            root.ondataavailable({data:interleaved, sampleRate:sampleRate});
            return;
        }
